...
lines_dictionary_log_train_map_pre_munnel = {
    ...
    'City Circle': [['Flinders Street', 'Southern Cross', 'Flagstaff', 'Melbourne Central', 'Parliament'],ptv_grey],
    'City Circle Loop': [['Southern Cross', 'Flagstaff', 'Melbourne Central', 'Parliament', 'Flinders Street'],ptv_grey],
    ...
    'Werribee Express': [['Frankston', 'Kananook', 'Seaford', 'Carrum', 'Bonbeach', 'Chelsea', 'Edithvale', 'Aspendale', 'Mordialloc', 'Parkdale', 'Mentone', 'Cheltenham', 'Southland', 'Highett', 'Moorabbin', 'Patterson', 'Bentleigh', 'McKinnon', 'Ormond', 'Glen Huntly', 'Caulfield', 'Malvern', 'Armadale', 'Toorak', 'Hawksburn', 'South Yarra', 'Richmond', 'Flinders Street', 'Southern Cross', 'North Melbourne', 'South Kensington', 'Footscray', 'Seddon', 'Yarraville', 'Spotswood', 'Newport', 'Laverton', 'Aircraft', 'Williams Landing', 'Hoppers Crossing', 'Werribee'],0x009645],
