...
Required:
    ...
    Location: input the name of the location the photo was taken. Note that Xm9G manually reads this so any info in any understandable form is acceptable.''',
        '/wongm': '''Unfortunately the entry for this command hasn't been completed. We're working on it right now. The list of commands who's entries also aren't finished is: </wongm:1288004355475111939>, </year-in-review:1294634052099375155>''',
        '/year-in-review': '''Unfortunately the entry for this command hasn't been completed. We're working on it right now. The list of commands who's entries also aren't finished is: </wongm:1288004355475111939>, </year-in-review:1294634052099375155>'''
    }
