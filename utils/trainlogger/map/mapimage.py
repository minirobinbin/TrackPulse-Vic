...
class MapImageHandler:
    def __init__(self, map_image_path, station_order_dictionary):
        self.station_coordinates = {
            ...
            "Sunshine": (-3000.0 + x_offset, 750.0 + y_offset, -2551.0 + x_offset, 749.0 + y_offset),
            ...
            "Ardeer": (-3900.0 + x_offset, 0.0 + y_offset, -3601.0 + x_offset, 149.0 + y_offset),
            "Deer Park": (-4950.0 + x_offset, 0.0 + y_offset, -4501.0 + x_offset, 149.0 + y_offset),
