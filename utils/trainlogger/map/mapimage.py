...
class MapImageHandler:
    def __init__(self, map_image_path, station_order_dictionary):
        self.station_coordinates = {
            ...
            "Little River": (-5800 + x_offset, 550 + y_offset, -5250 + x_offset, 700 + y_offset),
            "Lara": (-5550 + x_offset, 700 + y_offset, -5200 + x_offset, 900 + y_offset),
            "Corio": (-5550 + x_offset, 950 + y_offset, -5250 + x_offset, 1100 + y_offset),
            "North Shore": (-5800 + x_offset, 1150 + y_offset, -5250 + x_offset, 1300 + y_offset),
            "North Geelong": (-5950 + x_offset, 1350 + y_offset, -5200 + x_offset, 1500 + y_offset),
            "Geelong": (-5700 + x_offset, 1500 + y_offset, -5250 + x_offset, 1700 + y_offset),
            "South Geelong": (-5950 + x_offset, 1750 + y_offset, -5250 + x_offset, 1900 + y_offset),
            "Marshall": (-5650 + x_offset, 1950 + y_offset, -5200 + x_offset, 2100 + y_offset),
            "Waurn Ponds": (-5900 + x_offset, 2150 + y_offset, -5250 + x_offset, 2300 + y_offset),
            "Winchelsea": (-5700 + x_offset, 2350 + y_offset, -5150 + x_offset, 2500 + y_offset),
            "Birregurra": (-5650 + x_offset, 2500 + y_offset, -5150 + x_offset, 2700 + y_offset),
            "Colac": (-5400 + x_offset, 2700 + y_offset, -5150 + x_offset, 2900 + y_offset),
            "Camperdown": (-5800 + x_offset, 2900 + y_offset, -5150 + x_offset, 3100 + y_offset),
            "Terang": (-5500 + x_offset, 3150 + y_offset, -5150 + x_offset, 3300 + y_offset),
            "Sherwood Park": (-5850 + x_offset, 3350 + y_offset, -5150 + x_offset, 3500 + y_offset),
            "Warrnambool": (-5400 + x_offset, 3650 + y_offset, -4700 + x_offset, 3800 + y_offset),
