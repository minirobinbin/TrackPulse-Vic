...
class MapImageHandler:
    def __init__(self, map_image_path, station_order_dictionary):
        self.station_coordinates = {
            ...
            "Nar Nar Goon": (16700 + x_offset, 4200 + y_offset, 17350 + x_offset, 4350 + y_offset),
            "Tynong": (17350 + x_offset, 4200 + y_offset, 17800 + x_offset, 4400 + y_offset),
            "Garfield": (17800 + x_offset, 4150 + y_offset, 18150 + x_offset, 4400 + y_offset),
            "Bunyip": (18200 + x_offset, 4200 + y_offset, 18550 + x_offset, 4400 + y_offset),
            "Longwarry": (18550 + x_offset, 4200 + y_offset, 19100 + x_offset, 4350 + y_offset),
            "Drouin": (19100 + x_offset, 4150 + y_offset, 19450 + x_offset, 4350 + y_offset),
            "Warragul": (19400 + x_offset, 4100 + y_offset, 19950 + x_offset, 4350 + y_offset),
            "Yarragon": (19950 + x_offset, 4150 + y_offset, 20400 + x_offset, 4350 + y_offset),
            "Trafalgar": (20400 + x_offset, 4200 + y_offset, 20850 + x_offset, 4350 + y_offset),
            "Moe": (20900 + x_offset, 4250 + y_offset, 21100 + x_offset, 4350 + y_offset),
            "Morwell": (21150 + x_offset, 4200 + y_offset, 21550 + x_offset, 4400 + y_offset),
