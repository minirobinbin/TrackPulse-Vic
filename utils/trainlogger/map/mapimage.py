...
class MapImageHandler:
    def __init__(self, map_image_path, station_order_dictionary):
        self.station_coordinates = {
            ...
            "Prahran": (3800 + x_offset, 3100 + y_offset, 4250 + x_offset, 3250 + y_offset),
            "Windsor": (3350 + x_offset, 3100 + y_offset, 3850 + x_offset, 3250 + y_offset),
            "Balaclava": (2850 + x_offset, 3100 + y_offset, 3400 + x_offset, 3300 + y_offset),
            "Ripponlea": (2300 + x_offset, 3100 + y_offset, 2800 + x_offset, 3300 + y_offset),
            "Elsternwick": (1700 + x_offset, 3100 + y_offset, 2300 + x_offset, 3250 + y_offset),
            "Gardenvale": (1100 + x_offset, 3100 + y_offset, 1700 + x_offset, 3250 + y_offset),
            "North Brighton": (400 + x_offset, 3100 + y_offset, 1100 + x_offset, 3250 + y_offset),
            "Middle Brighton": (-400 + x_offset, 3100 + y_offset, 400 + x_offset, 3300 + y_offset),
            "Brighton Beach": (-1150 + x_offset, 3100 + y_offset, -350 + x_offset, 3300 + y_offset),
            "Hampton": (-1600 + x_offset, 3100 + y_offset, -1150 + x_offset, 3250 + y_offset),
            "Sandringham": (-2300 + x_offset, 2900 + y_offset, -1650 + x_offset, 3100 + y_offset),
            ...
            "Glen Huntly": (4250 + x_offset, 4450 + y_offset, 4850 + x_offset, 4650 + y_offset),
            "Ormond": (4450 + x_offset, 4650 + y_offset, 4850 + x_offset, 4850 + y_offset),
            "McKinnon": (4300 + x_offset, 4800 + y_offset, 4850 + x_offset, 5050 + y_offset),
            "Benteigh": (4400 + x_offset, 5050 + y_offset, 4850 + x_offset, 5250 + y_offset),
            "Patterson": (4300 + x_offset, 5200 + y_offset, 4850 + x_offset, 5500 + y_offset),
            "Moorabbin": (4350 + x_offset, 5450 + y_offset, 4850 + x_offset, 5650 + y_offset),
            "Highett": (4450 + x_offset, 5650 + y_offset, 4850 + x_offset, 5800 + y_offset),
            "Southland": (4300 + x_offset, 5900 + y_offset, 4850 + x_offset, 6050 + y_offset),
            "Cheltenham": (4250 + x_offset, 6050 + y_offset, 4850 + x_offset, 6250 + y_offset),
            "Mentone": (4300 + x_offset, 6250 + y_offset, 4850 + x_offset, 6450 + y_offset),
            "Parkdale": (4350 + x_offset, 6450 + y_offset, 4850 + x_offset, 6650 + y_offset),
            "Mordialloc": (4300 + x_offset, 6650 + y_offset, 4850 + x_offset, 6850 + y_offset),
            "Aspendale": (4300 + x_offset, 6850 + y_offset, 4850 + x_offset, 7000 + y_offset),
            "Edithvale": (4350 + x_offset, 7050 + y_offset, 4850 + x_offset, 7250 + y_offset),
            "Chelsea": (4400 + x_offset, 7250 + y_offset, 4850 + x_offset, 7400 + y_offset),
            "Bonbeach": (4200 + x_offset, 7400 + y_offset, 4900 + x_offset, 7650 + y_offset),
            "Carrum": (4400 + x_offset, 7650 + y_offset, 4900 + x_offset, 7850 + y_offset),
            "Seaford": (4450 + x_offset, 7850 + y_offset, 4850 + x_offset, 8050 + y_offset),
            "Kananook": (4350 + x_offset, 8100 + y_offset, 4850 + x_offset, 8250 + y_offset),
            "Frankston": (4250 + x_offset, 8250 + y_offset, 4850 + x_offset, 8450 + y_offset),
            "Leawarra": (5150 + x_offset, 8450 + y_offset, 5650 + x_offset, 8600 + y_offset),
            "Baxter": (5150 + x_offset, 8700 + y_offset, 5500 + x_offset, 8850 + y_offset),
            "Somerville": (5150 + x_offset, 8850 + y_offset, 5700 + x_offset, 9050 + y_offset),
            "Tyabb": (5150 + x_offset, 9100 + y_offset, 5500 + x_offset, 9250 + y_offset),
            "Hastings": (5150 + x_offset, 9250 + y_offset, 5650 + x_offset, 9450 + y_offset),
            "Bittern": (5150 + x_offset, 9450 + y_offset, 5550 + x_offset, 9650 + y_offset),
            "Mooradoo": (5150 + x_offset, 9650 + y_offset, 5700 + x_offset, 9850 + y_offset),
            "Crib Point": (5150 + x_offset, 9800 + y_offset, 5700 + x_offset, 10050 + y_offset),
            "Stony Point": (4750 + x_offset, 10200 + y_offset, 5400 + x_offset, 10350 + y_offset),
            "Carnegie": (5400 + x_offset, 3850 + y_offset, 5800 + x_offset, 4050 + y_offset),
            "Murrumbeena": (5850 + x_offset, 3850 + y_offset, 6500 + x_offset, 4100 + y_offset),
            "Hughesdale": (6550 + x_offset, 3850 + y_offset, 7150 + x_offset, 4050 + y_offset),
            "Oakleigh": (7200 + x_offset, 3850 + y_offset, 7650 + x_offset, 4050 + y_offset),
            "Huntingdale": (7650 + x_offset, 3850 + y_offset, 8250 + x_offset, 4050 + y_offset),
            "Clayton": (8250 + x_offset, 3850 + y_offset, 8650 + x_offset, 4050 + y_offset),
            "Westall": (8650 + x_offset, 3850 + y_offset, 9150 + x_offset, 4050 + y_offset),
            "Springvale": (9150 + x_offset, 3850 + y_offset, 9700 + x_offset, 4050 + y_offset),
            "Sandown Park": (9700 + x_offset, 3900 + y_offset, 10400 + x_offset, 4050 + y_offset),
            "Noble Park": (10450 + x_offset, 3900 + y_offset, 11000 + x_offset, 4050 + y_offset),
            "Yarraman": (11000 + x_offset, 3900 + y_offset, 11500 + x_offset, 4050 + y_offset),
            "Dandenong": (11550 + x_offset, 3900 + y_offset, 12100 + x_offset, 4100 + y_offset),
